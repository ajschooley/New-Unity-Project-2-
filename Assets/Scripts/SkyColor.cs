...
public class SkyColor : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //Method B
        //Use inverse lerp and calculatehow much time has passed since the start of the cycle
        //By multiplying it for how long a section of said cycle is
        currentLerping =
            Mathf.InverseLerp(0,
            fullCycleTime / 3,
            currentLerping * (fullCycleTime / 3) + Time.deltaTime);
